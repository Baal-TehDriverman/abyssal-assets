...
// CourtFile: MsnModernBallistics | Keter | agent=Lucifer
// CourtFile: MsnModernBallistics | Keter | agent=Lucifer
// Sephirotic Court Seal — Keter | desktop/cp2077_mods/msn_modern_ballistics.reds
...
public class MSNGoreSystem extends IScriptable {
    ...
    @Property public let BloodVolumeMultiplier: Float = 10.0;
    ...
    @Property public let MaxGibs: Int32 = 250;
    @Property public let DecalLifetime: Float = 300.0;
    ...
    private final func Initialize() -> Void {
        LilithSovereignKernel.GetInstance().RegisterSubsystem("MsnModernBallistics", 2);
