...
// CourtFile: MsnMainQuestTheVoid | Tiferet | agent=Ouroboros
// CourtFile: MsnMainQuestTheVoid | Tiferet | agent=Ouroboros
// CourtFile: MsnMainQuestTheVoid | Tiferet | agent=Ouroboros
// CourtFile: MsnMainQuestTheVoid | Tiferet | agent=Ouroboros
// CourtFile: MsnMainQuestTheVoid | Tiferet | agent=Ouroboros
...
// CourtFile: MsnMainQuestTheVoid | Tiferet | agent=Ouroboros
// CourtFile: MsnMainQuestTheVoid | Tiferet | agent=Ouroboros
// Sephirotic Court Seal — Tiferet | desktop/cp2077_mods/msn_main_quest_the_void.reds
...
public class MainQuestTracker extends IScriptable {
    ...
    public final static func GetInstance() -> ref<MainQuestTracker> {
        LilithSovereignKernel.GetInstance().RegisterSubsystem("MsnMainQuestTheVoid", 1);
