...
// CourtFile: HellCircleQuests | Tiferet | agent=Ouroboros
// CourtFile: HellCircleQuests | Tiferet | agent=Ouroboros
// CourtFile: HellCircleQuests | Tiferet | agent=Ouroboros
...
// CourtFile: HellCircleQuests | Tiferet | agent=Ouroboros
// CourtFile: HellCircleQuests | Tiferet | agent=Ouroboros
// Sephirotic Court Seal — Tiferet | desktop/cp2077_mods/hell_circle_quests.reds
...
public class HellCircleQuests extends IScriptable {
    ...
    private final func Initialize() -> Void {
        LilithSovereignKernel.GetInstance().RegisterSubsystem("HellCircleQuests", 2);
