...
// CourtFile: CyberpunkNgdIntegration | Keter | agent=Lucifer
// CourtFile: CyberpunkNgdIntegration | Keter | agent=Lucifer
// CourtFile: CyberpunkNgdIntegration | Keter | agent=Lucifer
// CourtFile: CyberpunkNgdIntegration | Keter | agent=Lucifer
// CourtFile: CyberpunkNgdIntegration | Keter | agent=Lucifer
...
// CourtFile: CyberpunkNgdIntegration | Keter | agent=Lucifer
// CourtFile: CyberpunkNgdIntegration | Keter | agent=Lucifer
// Sephirotic Court Seal — Keter | desktop/cp2077_mods/cyberpunk_ngd_integration.reds
...
public class NGDSystem extends IScriptable {
    ...
    private final func Initialize() -> Void {
        LilithSovereignKernel.GetInstance().RegisterSubsystem("CyberpunkNgdIntegration", 2);
...
public class CyberpunkNGDIntegration extends GameSystem {
    ...
    private final func FindCyberpunkProcess() -> ref<GameObject> {
        ...
        LogWarning("[NGD Integration] No player session — monitoring mode only");
        return null;
    }
